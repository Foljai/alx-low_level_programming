 ...
 * @file: The name of the files buffer is storing chars for.
 *
...
/**
 * main - Copies the contents of files to another files.
 * @argc: The numbers of argument supplied to the programs.
 * @argv: An array of pointers for the arguments.
 *
 * Return: 0 on success.
 *
